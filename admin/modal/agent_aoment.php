...
<div class="row  border-bottom white-bg dashboard-header">
	...
	<link rel="stylesheet" href="css/content.css" />
		...
		<div class="public-content">
			...
			<form class="form-horizontal" action="index.php?action=agent_aoment&c=update" method="post">
  
				 
				 	 <div class="form-group">
					<label for="">公告内容</label>
					<textarea id="editor_id" name="content" rows="12" class="form-control diff-textarea" placeholder='可输入HTML代码'><?=$webdata['agent_amt'] ?></textarea> 
				</div>
