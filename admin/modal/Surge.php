...
<div class="row  border-bottom white-bg dashboard-header">
	...
	<link rel="stylesheet" href="css/content.css" />
		...
		<div class="public-content">
			...
			<form class="form-horizontal" action="index.php?action=Surge&c=update" method="post">
  
				 
				 	 <div class="form-group">
					<label for="">Surge规则</label>
					<textarea id="editor_id" name="content" rows="12" class="form-control diff-textarea" placeholder=''><?php echo file_get_contents('surge.conf'); ?></textarea> 
				</div>
