...
<div class="row  border-bottom white-bg dashboard-header">
	...
	<link rel="stylesheet" href="css/content.css" />
		...
		<div class="public-content">
			...
			<form class="form-horizontal" action="index.php?action=web_gg_set&id=<?=$_GET['id']?>" method="post">
				<div class="form-group">
					<label for="">公告主题</label>
					<input type="hidden" name="id" value="<?=$_GET['id']?>" >
					<input class="form-input-txt" type="text" name="g_name" style="width: 50%;" value="<?=$Gdata['g_name']?>" />
				</div>
					...
					<textarea id="editor_id" name="g_conetent" rows="12" class="form-control diff-textarea" placeholder='可输入HTML代码'><?=$Gdata['g_conetent']?></textarea> 
				</div>
